...
abstract class StockManagerModuleCore extends Module
{
    ...
    public function hookStockManager()
    {
        ...
        if ($this->stock_manager_class === null || ! file_exists($class_file)) {
        ...
        if (! class_exists($this->stock_manager_class)) {
            exit($this->trans('Stock Manager class not found [%s]', [htmlspecialchars($this->stock_manager_class)], 'Admin.Catalog.Notification'));
        }

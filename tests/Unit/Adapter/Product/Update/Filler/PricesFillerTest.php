...
class PricesFillerTest extends ProductFillerTestCase
{
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('getDataToTestUnitPriceAndPricePropertiesFilling')]
    ...
    private function getFiller(bool $ecoTaxEnabled, ShopConstraint $shopConstraint): PricesFiller
    {
        ...
        $numberExtractor
            ->method('extract')
            ->willReturnCallback(fn (Product $product, string $propertyPath): DecimalNumber => new DecimalNumber((string) $product->{$propertyPath}))
        ;

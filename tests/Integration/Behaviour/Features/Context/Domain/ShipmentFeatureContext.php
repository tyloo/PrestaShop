...
class ShipmentFeatureContext extends AbstractDomainFeatureContext
{
    ...
    public function switchShipmentCarrier(string $shipmentReference, string $carrierReference): void
    {
        ...
        try {
            ...
            throw new RuntimeException(\sprintf('Error while switching shipment "%s" to carrier "%s" : %s', $shipmentReference, $carrierReference, $exception->getMessage()), $exception->getCode(), $exception);
        }
    }

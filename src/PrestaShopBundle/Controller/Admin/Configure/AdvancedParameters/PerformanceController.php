...
class PerformanceController extends PrestaShopAdminController
{
    ...
    public function indexAction(
        ...
        return $this->render('@PrestaShop/Admin/Configure/AdvancedParameters/performance.html.twig', [
            ...
            'smartyForm' => $smartyForm,
            'debugModeForm' => $debugModeForm,
            'optionalFeaturesForm' => $optionalFeaturesForm,
            'combineCompressCacheForm' => $combineCompressCacheForm,
            'mediaServersForm' => $mediaServersForm,
            'cachingForm' => $cachingForm,
            'memcacheForm' => $memcacheForm,

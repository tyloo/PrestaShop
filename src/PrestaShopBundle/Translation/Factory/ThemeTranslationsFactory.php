...
class ThemeTranslationsFactory extends TranslationsFactory
{
     ...
     */
    protected function removeLocaleFromDomain(string $locale, $domain): string
    {
     ...
     */
    protected function getFrontTranslationsForThemeAndLocale($themeName, $locale, $search = null): array
    {

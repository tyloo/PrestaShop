 ...
 */';
    ...
    private function findAndCheckExtension(OutputInterface $output, string $ext): void
    {
        ...
        foreach ($finder as $file) {
            ...
            if (\in_array($file->getRelativePathName(), $filesToIgnore, true)) {
                continue;
            }
    ...
    private function addLicenseToJsonFile(SplFileInfo $file): false|int
    {
        if (! \in_array($file->getFilename(), ['composer.json', 'package.json'], true)) {
            return false;
        }

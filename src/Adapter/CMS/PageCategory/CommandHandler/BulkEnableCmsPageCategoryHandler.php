...
final class BulkEnableCmsPageCategoryHandler implements BulkEnableCmsPageCategoryHandlerInterface
{
     ...
     */
    public function handle(BulkEnableCmsPageCategoryCommand $command): void
    {
        try {
            ...
            throw new CmsPageCategoryException('Unexpected error occurred when handling bulk enable cms category', 0, $prestaShopException);
        }
    }
}

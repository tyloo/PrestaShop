...
class ResetEmployeePasswordHandler implements ResetEmployeePasswordHandlerInterface
{
    ...
    {
        if (! ($employee = $this->employeePasswordResetter->getEmployeeByValidResetPasswordToken($command->getResetToken())) instanceof \PrestaShopBundle\Entity\Employee\Employee) {
